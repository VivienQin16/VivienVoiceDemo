...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ChatEnterViewController *newsMainVC = [[ChatEnterViewController alloc]init];
    mNavigationController = [[UINavigationController alloc] initWithRootViewController:newsMainVC]; //homeVC
